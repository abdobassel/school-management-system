...
<!-- row -->
<div class="row">
    <h3> قائمة الاسئلة : <span class="text-danger">{{ $quizz->name }}</span></h3>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('questionTeacher.show', $quizz->id) }}" class="btn btn-success btn-sm"
                                role="button" aria-pressed="true">اضافة
                                سؤال
                                جديد</a><br><br>
                                    ...
                                    <tbody>
                                        @foreach ($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('questionTeacher.edit', $question->id) }}"
