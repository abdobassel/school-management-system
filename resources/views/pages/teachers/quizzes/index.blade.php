        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('quizesTeacher.create') }}" class="btn btn-success btn-sm" role="button"
                                aria-pressed="true">اضافة
                                اختبار جديد</a><br><br>
                                        ...
                                        @foreach ($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('studentsQuizzeTeacher.show', $quizze->id) }}"
                                                        class="btn btn-info btn-sm" role="button"
                                                        title="عرض الطلاب المختبرين" aria-pressed="true"><i
                                                            class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal fade" id="delete_exam{{ $quizze->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{ route('quizesTeacher.destroy') }}" method="post">
                                                        @method('DELETE')
                                                        @csrf
