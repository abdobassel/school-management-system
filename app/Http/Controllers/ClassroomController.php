...
class ClassroomController extends Controller
{
    ...
    public function filterClasses(Request $request)
    {
        ...
        // بنجيب المراحل لعرض اسم المرحلة في جدول الصفوف فقط وليس لشي اخر 
        // لان المراحل انا باخد الا id فقط منها وبناءا عليه بعرش الكلاسروم
        // بنعمل سيرش بناءا على كل مرحلة في السيليكت وبعدين نعرض البيانات وكانها فيو اخر جديد 
        //  ولكن هو نفس الصفحة مع اختلاف البيانات المعروضة على حسب اي دي الجريد 
        // في الصفحة بقا فيه متغير لو موجود يعرض الكلاسس بناءا على اي دي الجريد والمتغير هو $details 
        // ولو مش موجود يكمل طبيعي بعرض كل البيانات من غير فلترة
    }
}
